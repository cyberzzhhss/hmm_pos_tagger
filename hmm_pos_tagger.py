...
UNK_WORDS = ['UNK','UNK_noun','UNK_verb','UNK_digit','UNK_adv','UNK_cap_noun','UNK_punct','UNK_adj',]
ADJ_SUFFIX = ['zy', 'dy', 'ese', 'less', 'ish', 'ian', 'able', 'esque', 'i', 'lly', 'ible', 'ous', 'ly', 'ive', 'sy', 'ful', 'al', 'ic', 'ical']
ADV_SUFFIX = ['ally', 'wards', 'wise', 'ily', 'ly', 'ward']
NOUN_SUFFIX = ['hood', 'ness', 'cy', 'ery', 'ation', 'ism', 'ance', 'or', 'scape', 'ure', 'ship', 'ist','er', 'dom', 'ry', 'action', 'acy', 'ion', 'al', 'age', 'ity', 'ty', 'ee', 'ence', 'ment', 'ling']
VERB_SUFFIX = ['ify', 'fy', 'ate', 'ize', 'ise']
...
with open('submission.pos', 'w') as out:
